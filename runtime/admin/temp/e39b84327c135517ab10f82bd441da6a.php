<?php /*a:1:{s:61:"D:\phpstudy_pro\WWW\www.tp6.com\app\admin\view\goods\add.html";i:1618900512;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="utf-8">
    ...
    <script src="/static/admin/lib/layui-v2.5.4/layui.js?1" charset="utf-8"></script>
    <link rel="stylesheet" href="/static/admin/css/sku_style.css"/>
    <script type="text/javascript" src="/static/admin/js/sku/createSkuTable.js?v19"></script>
</head>
<body>
...
<script src="/static/admin/js/uploads.js?c11"></script>
<script src="/static/admin/js/goods.js?c9"></script>
<script src="/static/admin/js/common.js?b4"></script>
<script>
    // 点击查看分类
    $('.change-type').on('click', function () {
        goods_cls_ids = $('#goods_cate').attr('data-ids');
        layObj.dialog("<?php echo url('category/dialog'); ?>")
    })
    ...
    layui.use(['form', 'layedit', 'laydate', 'element'], function () {
        ...
        $('body').on('click', '.add-spec-btn', function () {
            ...
            layObj.dialog("<?php echo url('specs/dialog'); ?>", '添加规格')
        })
        ...
        layui.form.on('submit(*)', function (data) {
            ...
            //获取form表单外的数据
            if ( goods_data.goods_specs_type == 1 )
            {
                //表示单规格,需要单独去获取form表单之外的 总库存、市场价、销售价
                goods_data.stock = $('#goods_stock').val();
                goods_data.market_price = $('#market_price').val();
                goods_data.sell_price = $('#sell_price').val();
            }
